...
class VRAE(BaseEstimator, nn.Module):
    ...
    def _train(self, train_loader,test_loader):
        ...
        epoch_loss = 0
        t = 0
        #partie d'entrainement, on regarde l'évolution de la perte moyenne 
        ...
        self.array_loss.append(epoch_loss / t)
        #partie test 
        epoch_loss = 0
        t = 0
        ...
        self.array_loss_test.append(epoch_loss / t)

    def fit(self, dataset,dataset_test, save = False):
        """
